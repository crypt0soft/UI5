...
jQuery.sap.require("com.test.MyRouter");
...
sap.ui.core.UIComponent.extend("com.test.Component", {
	metadata: {
		...
		config: {
			...
			serviceConfig: {
				name: "p151063trial.test.petrobras.services.Servicos",
				serviceUrl: ""
			}
		},
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.test");
